...
public class DateUtil {
    ...
    public static boolean isHoliday(Date day) {
        return (new DateHoliday()).isHoliday(day);
    }
    ...
    public static String getDifTime(String startTime, String endTime) {
        return (new DateHoliday()).getDifTime(startTime, endTime);
    }
    ...
    public static double getDifTwoTime(Date endDate, Date startDate, String tdatestr) {
        if (endDate == null || startDate != null) {
            return cn.linkey.orm.util.DateUtil.getDifTwoTime(endDate.getTime(), startDate.getTime(), tdatestr);
        }
        return 0;
    }
